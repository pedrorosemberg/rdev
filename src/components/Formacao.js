  ...
  return (
    <section id="formacao" className="py-10 px-5 bg-gray-800">
      ...
      <div className="mt-5 flex flex-col items-center">
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          ...
          <p className="text-white text-left">Engenharia de Software, Engenharia de Computação</p>
        ...
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          <div className="flex items-center">
            ...
            <h3 className="text-xl text-teal-400">Centro Federal de Educação Tecnológica de Minas Gerais</h3>
          </div>
          <p className="text-white text-left">Aluno Especial do Programa de Pós-Graduação de Mestrado em Administração, Administração e Negócios</p>
          <p className="text-white text-left">(julho de 2024)</p>
        </div>
        ...
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          ...
          <p className="text-white text-left">Pós-graduação em Psicanálise Clínica, Psicanálise</p>
        ...
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          ...
          <p className="text-white text-left">Extensão Universitária em Fundamentos da Psicanálise, Psicologia e Psicanálise</p>
        ...
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          ...
          <p className="text-white text-left">Pós-graduação Lato Sensu - MBA em Gestão Comercial e Inteligência de Mercado</p>
        ...
        <div className="bg-gray-700 p-4 mb-4 rounded w-full">
          ...
          <p className="text-white text-left">Pós-graduação Lato Sensu - MBA em Marketing, Criatividade e Inovação</p>
